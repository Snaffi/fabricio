...
docker_build_args_parser.add_argument('--no-cache', action='store_true', dest='no-cache')
docker_build_args_parser.add_argument('--pull', action='store_true')
docker_build_args_parser.add_argument('--force-rm', action='store_true', dest='force-rm')
docker_build_args_parser.add_argument('--custom')
docker_build_args_parser.add_argument('--custom-bool', action='store_true', dest='custom-bool')
